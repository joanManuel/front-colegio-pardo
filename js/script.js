...
jQuery(function ($) {
    ...
    const logoInit = document.querySelector('.logo-dark');
    const logoScroll = document.querySelector('.logo-light');
    $(window).on('scroll', function () {
        if ($(this).scrollTop() > 220) { // Set position from top to add class
            $('header').addClass('header-appear');
            logoInit.classList.add('logo-scroll')
            logoScroll.classList.remove('logo-init');
        }
        else {
            $('header').removeClass('header-appear');
            logoInit.classList.remove('logo-scroll')
            logoScroll.classList.add('logo-init');
        }
    });
    ...
    $(window).on('scroll', function () {
        if ($(this).scrollTop() > 500){
            ...
            // console.log('logoooo1-1');
           } else{
            $('.scroll-top-arrow').fadeOut('slow');
            // console.log('logoooo1-2');
        }
    });
